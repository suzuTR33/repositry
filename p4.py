...
def draw_human(canvas, center_x, center_y, width, height):
    ...
    arm_w = width//2
    arm_h = height//7
    canvas.create_line(center_x, head_y2+arm_h, center_x+arm_w, head_y2, fill='black')
    canvas.create_line(center_x, head_y2+arm_h, center_x-arm_w, head_y2, fill='black')

    #legs
    leg_w = width//2
    canvas.create_line(center_x, body_y2, center_x+leg_w, center_y+height//2, fill='black')
    canvas.create_line(center_x, body_y2, center_x-leg_w, center_y+height//2, fill='black')
